// ==UserScript==
// @name       [🚨OFFICIAL CRYPTICTECH ADREMOVER🚨] CRYPTICTECH ADREMOVER FOR ALL SITES BY CRYPTICX
// @version    1
// @description  🚨REMOVE ALL POPUPS & ADS ARE REMOVED 99.99% FROM ALL SITES🚨
// @match      http://*/*
// @match      https://*/*
...
//CrypticTech AdRemover object
uw.adremover = {
thisScriptVersion: "CrypticTech V2.5",
...
createInfoElement: function(removed_elements, removed_images, removed_objects) {
	...
	adrel.style.background="rgba(0, 255, 255,0.9)";
	...
	setTimeout("adremover.hideInfoElement()", 9000);
},
